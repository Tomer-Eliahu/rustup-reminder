...
suite('Extension Test Suite', () => {
	...
	test('Whole Extension', ()=> {
		...
		//CI min wait time for tests to pass is 6_000 miliseconds (used to be 5_000)
		const ci_min_wait = 6000;
	...
	test('Whole Extension with addtional asserts and logs', ()=> {
		...
		//CI min wait time for tests to pass is 6_000 miliseconds (used to be 5000)
		const ci_min_wait = 6000;
